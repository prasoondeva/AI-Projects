(define (problem pacmanP)
    ...
    (:init (pacman-at pac1 loc_x1y1) (pacman-at pac2 loc_x2y2)
           (south loc_x2y1 loc_x1y1) (east loc_x1y2 loc_x1y1) (south loc_x2y2 loc_x1y2) (west loc_x1y1 loc_x1y2) (east loc_x1y3 loc_x1y2) 
           ...
           (north loc_x1y2 loc_x2y2) (east loc_x2y4 loc_x2y3) (south loc_x3y3 loc_x2y3) (west loc_x2y2 loc_x2y3) (north loc_x1y3 loc_x2y3) (south loc_x3y4 loc_x2y4) 
    ...
    (:goal (and (pacman-at pac1 loc_x1y4) (pacman-at pac2 loc_x1y4)))
)
